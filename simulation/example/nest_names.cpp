...
namespace names
{
// // Specific to iaf_psc_delta_int
// // Bit width of membrane potential
// const Name VBits("VBits");
// // Bit width of the significand of the membrane potential decay ratio
// const Name VdecBits("VdecBits");
// // Significand of the membrane potential step decay ratio
// const Name Vdec_sig("Vdec_sig");
// // Bit width of synaptic weights
// const Name wBits("wBits");
// // Bit width of synaptic weight accumulators
// const Name wAccBits("wAccBits");
// // Shift amount of weight accumulator values
// const Name wAccShift("wAccShift");
...
const Name subtraction("subtraction");//add
