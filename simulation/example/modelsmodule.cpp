...
ModelsModule::init( SLIInterpreter* )
{
  ...
  kernel().model_manager.register_node_model< iaf_delta_noleak >( "iaf_delta_noleak" );
  // kernel().model_manager.register_node_model< iaf_psc_delta_int >( "iaf_psc_delta_int" );
  // kernel().model_manager.register_node_model< iaf_psc_delta_leak >( "iaf_psc_delta_leak" );
