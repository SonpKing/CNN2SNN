...
import os
import numpy as np
from hardware.clone_conf import clone_conf
...
def create_config():
    ...
    connfiles = [
        'connections_anno_loss_weight_7/start_to_input_chip0',  # 1 3072
        'connections_anno_loss_weight_7/input_to_net.conv_stem_chip0',  # 3072 3840
        'connections_anno_loss_weight_7/net.conv_stem_to_net.blocks.0.0.conv_dw_chip0',  # 3840 3840
        'connections_anno_loss_weight_7/net.blocks.0.0.conv_dw_to_net.blocks.0.0.conv_pw_chip0',  # 3840 6144
        'connections_anno_loss_weight_7/net.blocks.0.0.conv_pw_to_net.blocks.1.0.conv_pw_chip0',  # 6144 12023
        'connections_anno_loss_weight_7/net.blocks.1.0.conv_pw_to_net.blocks.1.0.conv_dw_chip0',  # 12023 3008
        'connections_anno_loss_weight_7/net.blocks.1.0.conv_dw_to_net.blocks.1.0.conv_pwl_chip0',  # 3008 2048
        'connections_anno_loss_weight_7/net.blocks.1.0.conv_pwl_to_net.blocks.1.1.conv_pw_chip0',  # 2048 7488
        'connections_anno_loss_weight_7/net.blocks.1.1.conv_pw_to_net.blocks.1.1.conv_dw_chip0',  # 7488 7488
        'connections_anno_loss_weight_7/net.blocks.1.1.conv_dw_to_net.blocks.1.1.conv_pwl_chip0',  # 7488 2048
        'connections_anno_loss_weight_7/net.blocks.1.1.conv_pwl_to_net.blocks.2.0.conv_pw_chip0',  # 2048 6012
        'connections_anno_loss_weight_7/net.blocks.2.0.conv_pw_to_net.blocks.2.0.conv_dw_chip0',  # 6012 1504
        'connections_anno_loss_weight_7/net.blocks.2.0.conv_dw_to_net.blocks.2.0.conv_pwl_chip0',  # 1504 640
        'connections_anno_loss_weight_7/net.blocks.2.0.conv_pwl_to_net.blocks.2.1.conv_pw_chip0',  # 640 3120
        'connections_anno_loss_weight_7/net.blocks.2.1.conv_pw_to_net.blocks.2.1.conv_dw_chip0',  # 3120 3120
        'connections_anno_loss_weight_7/net.blocks.2.1.conv_dw_to_net.blocks.2.1.conv_pwl_chip0',  # 3120 640
        'connections_anno_loss_weight_7/net.blocks.2.1.conv_pwl_to_net.blocks.2.2.conv_pw_chip0',  # 640 1888
        'connections_anno_loss_weight_7/net.blocks.2.2.conv_pw_to_net.blocks.2.2.conv_dw_chip0',  # 1888 1888
        'connections_anno_loss_weight_7/net.blocks.2.2.conv_dw_to_net.blocks.2.2.conv_pwl_chip0',  # 1888 640
        'connections_anno_loss_weight_7/net.blocks.2.2.conv_pwl_to_net.conv_head_chip0',  # 640 4064
        'connections_anno_loss_weight_7/net.conv_head_to_net.global_pool_chip0',  # 4064 254
        'connections_anno_loss_weight_7/net.global_pool_to_net.classifier_chip0'  # 254 8
    ]
    tmp = []
    ...
    clone_conf()
    print("generate all config over")
    # ------------------------------------- input ----------------------------------------------总共只要一个
    # 加载输入层
